...
public class FoodMenu {
	...
	public FoodMenu(ProdOrdTable prodOrdTable) {

		jPanel = new JPanel();
		jPanel.setBounds(0, 0, 1050, 650);

		String[] menu = { "김치볶음밥", "낙지볶음밥", "닭갈비덮밥", "등심돈까스덮밥", "소불고기볶음밥", "스팸마요덮밥", "육개장", "제육덮밥", "짜장덮밥", "치킨마요덮밥" };
		JLabel[] menuNm = new JLabel[menu.length];
		JLabel[] menuImg = new JLabel[menu.length];
		JLabel[] menuPrice = new JLabel[menu.length];
		ImageIcon[] img = { 
				new ImageIcon("src/projectimages3/김치볶음밥.jpg"), new ImageIcon("src/projectimages3/낙지볶음밥.jpg"), 
				new ImageIcon("src/projectimages3/닭갈비덮밥.jpg"), new ImageIcon("src/projectimages3/등심돈까스덮밥.jpg"), 
				new ImageIcon("src/projectimages3/소불고기볶음밥.jpg"), new ImageIcon("src/projectimages3/스팸마요덮밥.jpg"),
				new ImageIcon("src/projectimages3/육개장.jpg"), new ImageIcon("src/projectimages3/제육덮밥.jpg"),
				new ImageIcon("src/projectimages3/짜장덮밥.jpg"), new ImageIcon("src/projectimages3/치킨마요덮밥.jpg")};
		int[] arrayMenuPrice = { 4000, 5000, 5000, 5000, 5500, 3500, 4000, 5000, 3500, 3500 };

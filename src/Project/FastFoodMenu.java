...
public class FastFoodMenu {
	...
	public FastFoodMenu(ProdOrdTable prodOrdTable) {

		jPanel = new JPanel();
		jPanel.setBounds(0, 0, 1050, 650);

		String[] menu = { "감자튀김", "불고기버거", "어니언링", "치즈버거", "치킨버거", "통새우버거" };
		JLabel[] menuNm = new JLabel[menu.length];
		JLabel[] menuImg = new JLabel[menu.length];
		JLabel[] menuPrice = new JLabel[menu.length];
		ImageIcon[] img = { 
				new ImageIcon("src/projectimages4/감자튀김.png"), new ImageIcon("src/projectimages4/불고기버거.png"), 
				new ImageIcon("src/projectimages4/어니언링.png"), new ImageIcon("src/projectimages4/치즈버거.png"), 
				new ImageIcon("src/projectimages4/치킨버거.png"), new ImageIcon("src/projectimages4/통새우버거.png")};
		int[] arrayMenuPrice = { 1500, 5000, 2000, 3200, 4000, 5500 };
